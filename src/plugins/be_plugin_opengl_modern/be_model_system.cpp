...
#include "LinearMath/btTransform.h"
	...
	void BeGraphicsModel::upload(Texturestore& textureStore)
	{
		...
		// Bind and enable VBO for vertices
		m_arrayBuffer->bind();
		glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 0, 0);
		glEnableVertexAttribArray(0);

		// Bind and enable VBO for normals
		glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 0, (void*)(m_numberVertices * sizeof(btScalar)));
		glEnableVertexAttribArray(1);

		// Bind and enable VBO for texture coordinates
		glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, 0, (void*)((m_numberVertices * sizeof(btScalar)) + (m_numberNormals * sizeof(GLfloat))));
...
// 		// glEnableVertexAttribArray(0); 
// 		// glVertexAttribPointer( 0, 3, GL_FLOAT, GL_FALSE, 0, m_arrayBuffer.get() );
// 
// 		m_vertexArray->normalPointer( *m_arrayBuffer, GL_FLOAT, 0, m_numberVertices*sizeof(btScalar) );
// 		// glEnableVertexAttribArray(1); 
// 		// glVertexAttribPointer( 1, 3, GL_FLOAT, GL_FALSE, 0, &(m_arrayBuffer.get()[m_numberVertices*sizeof(btScalar)]) );
// 		// glVertexAttribPointer( 1, 3, GL_FLOAT, GL_FALSE, 0, m_arrayBuffer.get()[m_numberVertices*sizeof(btScalar)] );
// 
