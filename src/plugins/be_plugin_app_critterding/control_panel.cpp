			...
			// LINE EDITS
				...
				// ROW 2
					...
					layout_H = layout_H_row->addChild( "mutationruns_max layout", "QHBoxLayout" );
					{
						...
						line_edit_mutationruns_max->set("mutationruns_max");
				...
				// ROW 3
					...
					layout_H = layout_H_row->addChild( "avg_adam_distance_layout", "QHBoxLayout" );
					{
						...
						m_line_edit_avg_adam_distance= layout_H->addChild( "avg_adam_distance_lineedit", "QLineEdit_float" );
						m_line_edit_avg_adam_distance->set( "0.0" );
					...
					layout_H = layout_H_row->addChild( "generations layout", "QHBoxLayout" );
					{
						...
						m_line_edit_generations= layout_H->addChild( "generations_lineedit", "QLineEdit_float" );
				...
				// ROW 4
					...
					layout_H = layout_H_row->addChild( "critters_layout", "QHBoxLayout" );
					{
						...
						m_line_edit_critters= layout_H->addChild( "critters_lineedit", "QLineEdit_uint" );
					...
					layout_H = layout_H_row->addChild( "food layout", "QHBoxLayout" );
					{
						...
						m_line_edit_food= layout_H->addChild( "food_lineedit", "QLineEdit_int" );
				...
				// ROW 5
					...
					layout_H = layout_H_row->addChild( "total neurons layout", "QHBoxLayout" );
					{
						...
						m_line_edit_total_neurons = layout_H->addChild( "neurons_lineedit", "QLineEdit_uint" );
					...
					layout_H = layout_H_row->addChild( "total synapses layout", "QHBoxLayout" );
					{
						...
						m_line_edit_total_synapses = layout_H->addChild( "total_synapses_lineedit", "QLineEdit_uint" );
				...
				// ROW 6
					...
					layout_H = layout_H_row->addChild( "avg neurons layout", "QHBoxLayout" );
					{
						...
						m_line_edit_avg_neurons = layout_H->addChild( "avg_neurons_lineedit", "QLineEdit_float" );
					...
					layout_H = layout_H_row->addChild( "avg synapses layout", "QHBoxLayout" );
					{
						...
						m_line_edit_avg_synapses = layout_H->addChild( "avg_synapses_lineedit", "QLineEdit_float" );
